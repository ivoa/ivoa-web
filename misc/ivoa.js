...
function changeValue(objectSource,objectTarget) {
  ...
  if(document.getElementById('doctypeSource').value!='' && document.getElementById('groupSource').value!='' && document.getElementById('fileSource').value != '') {
    var now = new Date();
    ...
    var filebase = basename(document.getElementById('fileSource').value);
    var url = '<b>http://www.ivoa.net/Documents/'+MyDocType[1][document.getElementById('doctypeSource').value]+'/'+MyDocType[1][document.getElementById('groupSource').value]+'/'+filebase+'-'+year+monthnumber+monthday+'.*</b>';
    document.getElementById('URLTarget').innerHTML = url;
  }
...
function copyValue() {
  ...
  changeValue('version3Source','version3Target');
...
function resetPreview() {
  ...
  document.getElementById('version3Target').innerHTML = "0";
